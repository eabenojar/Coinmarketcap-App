        ...
        <ul className="row">
          <div className="col-lg-3 col-md-3 col-sm-3 col-xs-6">
            <div className="navbar-grid">
              ...
              <li className="navbar-titles-value">$ {this.props.globaldata.total_market_cap_usd.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</li>
            </div>
          </div>
          <div className="col-lg-3 col-md-3 col-sm-3 col-xs-6">
            <div className="navbar-grid">
              <li className="navbar-titles">24H VOLUME</li>
              <li className="navbar-titles-value">$ {this.props.globaldata.total_24h_volume_usd.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</li>
            </div>
          </div>
          <div className="col-lg-3 col-md-3 col-sm-3 col-xs-6">
            <div className="navbar-grid">
